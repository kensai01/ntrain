...
class ContactResourceIT {
    ...
    void putExistingContact() throws Exception {
        ...
        updatedContact.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL).message(UPDATED_MESSAGE);
    ...
    void partialUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.firstName(UPDATED_FIRST_NAME).email(UPDATED_EMAIL).message(UPDATED_MESSAGE);
    ...
    void fullUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL).message(UPDATED_MESSAGE);
