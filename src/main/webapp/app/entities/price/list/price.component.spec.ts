...
describe('Price Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'price', component: PriceComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to priceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPriceIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPriceIdentifier).toHaveBeenCalledWith(entity);
