...
describe('Videos Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pages/videos', component: VideosComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to videoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getVideosIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getVideosIdentifier).toHaveBeenCalledWith(entity);
