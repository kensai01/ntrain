...
describe('Workouts Management Component', () => {
  let comp: WorkoutsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'workout', component: WorkoutsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(WorkoutsComponent, '')
      .compileComponents();
