...
import { IWorkout } from '../../../entities/workout/workout.model';
...
describe('Workouts routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let routingResolveService: WorkoutsRoutingResolveService;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(WorkoutsRoutingResolveService);
